  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { hid: 'description', name: 'description', content: 'Roberto Teixeira | Mobile Engineer.' },
        { hid: 'og:title', property: 'og:title', content: siteTitle },
        { hid: 'og:description', property: 'og:description', content: 'Roberto Teixeira | Mobile Engineer.' },
        { hid: 'og:image', property: 'og:image', content: 'demo-share.jpg' },
        { hid: 'og:url', property: 'og:url', content: 'https://robertoteixeira.netlify.app/' },
